...
<li class="breadcrumb-item"><a href="{{ route('painel.pacientes.index') }}">Clientes</a></li>
...
<div class="row g-3">
    ...
    <div class="col-lg-4">
        ...
        <div class="card-body text-center" style="padding:2rem 1.5rem;">
            ...
            <p style="font-size:.8375rem;color:var(--sabenta-text-muted);margin-bottom:1.25rem;">Cliente desde Janeiro/2024</p>
            ...
            <div class="d-grid gap-2">
                <a href="{{ route('painel.agenda.dia') }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-calendar-plus me-1"></i>Agendar atendimento
                </a>
            </div>
        </div>
        <div style="border-top:1px solid var(--sabenta-border);padding:1.25rem;">
            <div class="row g-3 text-center mb-3">
                @foreach([['Total atendimentos','24','bi-calendar3','var(--sabenta-primary)'],['Realizados','21','bi-check-circle','var(--status-confirmado)'],['Faltas','2','bi-x-circle','var(--status-faltou)'],['Investido','R$ 4.200','bi-cash-coin','var(--status-pendente)']] as $s)
                <div class="col-6">
    ...
    <div class="col-lg-8">
        ...
        <div class="tab-content">
            ...
            @php
            $hist = [
                ['17/04/2025','09:00','Atendimento Individual','realizado','R$ 200','Pix'],
                ['10/04/2025','09:00','Atendimento Individual','realizado','R$ 200','Pix'],
                ['03/04/2025','09:00','Atendimento Individual','faltou','R$ 200','—'],
                ['27/03/2025','09:00','Atendimento Individual','realizado','R$ 200','Transferência'],
                ['20/03/2025','09:00','Atendimento Individual','realizado','R$ 200','Pix'],
            ];
            @endphp
            ...
            <div style="padding:1.25rem;">
                @php
                $proximas = [
                    ['24/04/2025','Qui','09:00','Atendimento Individual','50 min'],
                    ['01/05/2025','Qui','09:00','Atendimento Individual','50 min'],
                    ['08/05/2025','Qui','09:00','Atendimento Individual','50 min'],
                ];
                @endphp
...
<div class="modal-header">
    <h5 class="modal-title text-danger"><i class="bi bi-trash me-2"></i>Excluir cliente</h5>
...
<div class="modal-body">
    <div class="p-3 mb-3 rounded-3" style="background:rgba(220,38,38,.06);border:1px solid rgba(220,38,38,.2);">
        ...
        <p style="font-size:.8rem;color:var(--sabenta-text-muted);margin-top:.35rem;margin-bottom:0;">Todo o histórico e atendimentos de <strong>Mariana Costa</strong> serão permanentemente excluídos.</p>
    </div>
